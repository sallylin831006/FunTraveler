...
class SearchProvider {
    ...
    func fetchSearch(keyword: String, position: String, radius: Int, completion: @escaping SearchHanlder) {
      ...
      let searchMockData = GoogleMapResponse(results: [Results(
        ...
        name: "Lady M 旗艦店", rating: Optional(3.9), userRatingsTotal: 2773, vicinity: "大安區光復南路240巷26號", placeId: "ChIJe2UCUMarQjQRdymATStlwUA"),
                                                       Results(
            geometry: Geometry(location: Location(lat: 25.029398, lng: 121.56259)),
            name: "幸福微甜手做diy烘焙屋", rating: Optional(4.4), userRatingsTotal: 2773, vicinity: "信義區莊敬路253號1樓", placeId: "ChIJe2UCUMarQjQRdymATStlwUA"),
                                                       Results(
            geometry: Geometry(location: Location(lat: 25.041012, lng: 121.56516)),
            name: "YTM亞尼克蛋糕提領站(市政府站)", rating: Optional(2.0), userRatingsTotal: 2773, vicinity: "信義區忠孝東路五段2號", placeId: "ChIJe2UCUMarQjQRdymATStlwUA"),
                                                       Results(
            geometry: Geometry(location: Location(lat: 25.036215, lng: 121.56727)),
            name: "起士公爵 乳酪蛋糕/彌月蛋糕/無麩質甜點", rating: Optional(5.0), userRatingsTotal: 2773, vicinity: "信義區松壽路11號", placeId: "ChIJe2UCUMarQjQRdymATStlwUA"),
                                                       Results(
            geometry: Geometry(location: Location(lat: 25.036215, lng: 121.56727)),
            name: "起士公爵 乳酪蛋糕/彌月蛋糕/無麩質甜點", rating: Optional(5.0), userRatingsTotal: 2773, vicinity: "信義區松壽路11號", placeId: "ChIJe2UCUMarQjQRdymATStlwUA"),
                                                       Results(
